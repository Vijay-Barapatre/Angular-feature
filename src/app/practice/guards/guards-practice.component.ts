...
@Component({
    ...
    template: `
        <div class="practice-container">
            <header class="practice-header">
                ...
                <h1>🛡️ Guards Practice</h1>
                <p class="subtitle">Master route protection with Angular Guards</p>
            </header>
            ...
            <nav class="exercise-nav">
                ...
                <div class="nav-section">
                    ...
                    <a routerLink="complex/scenario-2" routerLinkActive="active">
                        Scenario 2: Lazy Loading Guards
                    </a>
    ...
    styles: [`
        ...
        .back-link { color: #8b5cf6; text-decoration: none; font-size: 0.9rem; }
...
export class GuardsPracticeComponent { }
