...
// Exercises
@Component({
    selector: 'app-dc-exercise-1',
    standalone: true,
    imports: [CommonModule],
    template: `
        <div class="exercise">
            <div class="instructions">
                <h2>🟦 Exercise 1: ViewContainerRef</h2>
                <p>Create components dynamically using ViewContainerRef.</p>
            </div>
            <div class="demo">
                <pre>vcr.createComponent(MyComponent)</pre>
            </div>
        </div>
    `,
    styles: [`
...
@Component({
    selector: 'app-dc-exercise-2',
    standalone: true,
    imports: [CommonModule],
    template: `
        <div class="exercise">
            <div class="instructions">
                <h2>🟦 Exercise 2: Component Inputs</h2>
                <p>Pass data to dynamically created components.</p>
            </div>
            <div class="demo">
                <pre>const ref = vcr.createComponent(Comp);
ref.setInput('data', myData);</pre>
            </div>
        </div>
    `,
    styles: [`
...
@Component({
    selector: 'app-dc-exercise-3',
    standalone: true,
    imports: [CommonModule],
    template: `
        <div class="exercise">
            <div class="instructions">
                <h2>🟦 Exercise 3: Lazy Loading</h2>
                <p>Load components on demand.</p>
            </div>
            <div class="demo">
                <pre>const &#123; default: Comp &#125; = await import('./comp');
vcr.createComponent(Comp);</pre>
            </div>
        </div>
    `,
    styles: [`
...
@Component({
    selector: 'app-dc-exercise-4',
    standalone: true,
    imports: [CommonModule],
    template: `
        <div class="exercise">
            <div class="instructions">
                <h2>🟦 Exercise 4: ngComponentOutlet</h2>
                <p>Simpler dynamic component rendering.</p>
            </div>
            <div class="demo">
                <pre>&lt;ng-container *ngComponentOutlet="component"&gt;&lt;/ng-container&gt;</pre>
            </div>
        </div>
    `,
    styles: [`
...
// Complex Scenarios
@Component({
    selector: 'app-dc-scenario-1',
    standalone: true,
    imports: [CommonModule],
    template: `
        <div class="scenario">
            <div class="instructions">
                <h2>🟥 Scenario 1: Modal Service</h2>
                <p>Create modals dynamically.</p>
            </div>
            <div class="content">
                <p>Service that opens modals with any component.</p>
            </div>
        </div>
    `,
    styles: [`
...
@Component({
    selector: 'app-dc-scenario-2',
    standalone: true,
    imports: [CommonModule],
    template: `
        <div class="scenario">
            <div class="instructions">
                <h2>🟥 Scenario 2: Dashboard Widgets</h2>
                <p>Drag and drop widgets.</p>
            </div>
            <div class="content">
...
@Component({
    selector: 'app-dc-scenario-3',
    standalone: true,
    imports: [CommonModule],
    template: `
        <div class="scenario">
            <div class="instructions">
                <h2>🟥 Scenario 3: Form Builder</h2>
                <p>Dynamic form field generation.</p>
            </div>
            <div class="content">
                <p>Build forms from configuration.</p>
            </div>
        </div>
    `,
    styles: [`
...
@Component({
    selector: 'app-dc-scenario-4',
    standalone: true,
    imports: [CommonModule],
    template: `
        <div class="scenario">
            <div class="instructions">
                <h2>🟥 Scenario 4: Plugin System</h2>
                <p>Extensible plugin architecture.</p>
            </div>
            <div class="content">
                <p>Load plugins at runtime.</p>
            </div>
        </div>
    `,
    styles: [`
...
@Component({
    selector: 'app-dc-scenario-5',
    standalone: true,
    imports: [CommonModule],
    template: `
        <div class="scenario">
            <div class="instructions">
                <h2>🟥 Scenario 5: Tab Container</h2>
                <p>Dynamic tab content.</p>
            </div>
            <div class="content">
                <p>Lazy-load tab content.</p>
            </div>
        </div>
    `,
    styles: [`
