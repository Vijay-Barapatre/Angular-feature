...
## 📋 Table of Contents
- [🔗 How @ContentChild Works: Deep Dive](#how-contentchild-works-deep-dive)
  - [ViewChild vs ContentChild: Visual Comparison](#viewchild-vs-contentchild-visual-comparison)
  - [Lifecycle Timing: ContentChild vs ViewChild](#lifecycle-timing-contentchild-vs-viewchild)
  ...
  - [Visual: What Goes Where](#visual-what-goes-where)
- [1. 🔍 What is @ContentChild?](#1--what-is-contentchild)
- [2. 🚀 ViewChild vs ContentChild](#2--viewchild-vs-contentchild)
- [3. ❓ Interview Questions](#3--interview-questions)
  - [Basic Questions](#basic-questions)
    - [Q1: When use ContentChild vs ViewChild?](#q1-when-use-contentchild-vs-viewchild)
    - [Q2: When is ContentChild available?](#q2-when-is-contentchild-available)
  - [Scenario-Based Questions](#scenario-based-questions)
    - [Scenario: Tab Container](#scenario-tab-container)
- [📬 Mail Slot Analogy (Easy to Remember!)](#mail-slot-analogy-easy-to-remember)
