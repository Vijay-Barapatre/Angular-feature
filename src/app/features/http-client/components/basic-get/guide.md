...
- [1. 🔍 How It Works (The Concept)](#1--how-it-works-the-concept)
  ...
  - [Observable vs Immediate](#observable-vs-immediate)
  - [📊 Data Flow Diagram](#data-flow-diagram)
- [2. 🚀 Step-by-Step Implementation Guide](#2--step-by-step-implementation-guide)
  - [Step 1: Inject HttpClient (via Service)](#step-1-inject-httpclient-via-service)
  - [Step 2a: Manual Subscribe (Component)](#step-2a-manual-subscribe-component)
  - [Step 2b: Async Pipe (Recommended!)](#step-2b-async-pipe-recommended)
  - [📊 Async Pipe Flow](#async-pipe-flow)
- [3. 🐛 Common Pitfalls & Debugging](#3--common-pitfalls--debugging)
  - [❌ Pitfall 1: Forgetting to Subscribe](#pitfall-1-forgetting-to-subscribe)
  - [❌ Pitfall 2: Memory Leaks (No Unsubscribe)](#pitfall-2-memory-leaks-no-unsubscribe)
- [4. ⚡ Performance & Architecture](#4--performance--architecture)
  - [When to Use What](#when-to-use-what)
  - [Best Practice: Service Returns Observable](#best-practice-service-returns-observable)
- [5. 🌍 Real World Use Cases](#5--real-world-use-cases)
- [6. 📝 The Analogy: "Magazine Subscription" 📰](#6--the-analogy-magazine-subscription)
- [7. ❓ Interview & Concept Questions](#7--interview--concept-questions)
  - [Basic Questions](#basic-questions)
    - [Q1: Why does HttpClient return an Observable instead of a Promise?](#q1-why-does-httpclient-return-an-observable-instead-of-a-promise)
    - [Q2: What happens if you don't unsubscribe from an HTTP Observable?](#q2-what-happens-if-you-dont-unsubscribe-from-an-http-observable)
    - [Q3: Which is better: subscribe() or async pipe?](#q3-which-is-better-subscribe-or-async-pipe)
    - [Q4: How do you type an HTTP response?](#q4-how-do-you-type-an-http-response)
  - [Scenario-Based Questions](#scenario-based-questions)
    - [Scenario 1: Loading State Management](#scenario-1-loading-state-management)
    - [Scenario 2: Multiple Subscriptions](#scenario-2-multiple-subscriptions)
    - [Scenario 3: Component Destroyed Mid-Request](#scenario-3-component-destroyed-mid-request)
    - [Scenario 4: Conditional Fetching](#scenario-4-conditional-fetching)
  - [Advanced Questions](#advanced-questions)
    - [Q5: What's the difference between `tap()` and `map()`?](#q5-whats-the-difference-between-tap-and-map)
    - [Q6: When would you use `finalize()` vs putting code in the subscribe callback?](#q6-when-would-you-use-finalize-vs-putting-code-in-the-subscribe-callback)
- [🧠 Mind Map](#mind-map)
- [🎯 What Problem Does This Solve?](#what-problem-does-this-solve)
  - [The Problem: Traditional HTTP Is Eager and Hard to Cancel](#the-problem-traditional-http-is-eager-and-hard-to-cancel)
  - [How HttpClient/Observables Solve This](#how-httpclientobservables-solve-this)
- [📚 Key Classes & Types Explained](#key-classes--types-explained)
  - [1. `HttpClient` Service](#1-httpclient-service)
  - [2. `Observable<T>` Type](#2-observablet-type)
  - [3. `Subscription` Type](#3-subscription-type)
  - [4. AsyncPipe](#4-asyncpipe)
- [❓ Additional Interview Questions (10+)](#additional-interview-questions-10)
  - [RxJS Operator Questions](#rxjs-operator-questions)
