...
- [🚚 Moving Truck Analogy (Easy to Remember!)](#moving-truck-analogy-easy-to-remember)
  - [📖 Story to Remember:](#story-to-remember)
  - [🎯 Quick Memory:](#quick-memory)
- [2. 🚀 Implementation](#2--implementation)
  - [Upload with Progress](#upload-with-progress)
  - [Download as Blob](#download-as-blob)
- [3. ❓ Interview Questions](#3--interview-questions)
  - [Basic Questions](#basic-questions)
    - [Q1: How do you track file upload progress?](#q1-how-do-you-track-file-upload-progress)
    - [Q2: What's the difference between responseType 'blob' and 'arraybuffer'?](#q2-whats-the-difference-between-responsetype-blob-and-arraybuffer)
  - [Scenario-Based Questions](#scenario-based-questions)
    - [Scenario 1: Upload with Progress Bar](#scenario-1-upload-with-progress-bar)
    - [Scenario 2: Download and Save File](#scenario-2-download-and-save-file)
- [🧠 Mind Map](#mind-map)
