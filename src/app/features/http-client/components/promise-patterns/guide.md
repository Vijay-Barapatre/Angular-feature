...
- [📚 Patterns Covered](#patterns-covered)
  - [1. Old vs New Pattern](#1-old-vs-new-pattern)
  - [2. Promise.all() - Parallel with Fail-Fast](#2-promiseall---parallel-with-fail-fast)
  - [3. Promise.allSettled() - Wait for All Results](#3-promiseallsettled---wait-for-all-results)
  - [4. Promise.race() - First Response Wins](#4-promiserace---first-response-wins)
  - [5. Promise.any() (ES2021)](#5-promiseany-es2021)
- [⚠️ Angular-Specific Notes](#angular-specific-notes)
- [🔑 Key Takeaways](#key-takeaways)
- [🏎️ Race Track Analogy (Easy to Remember!)](#race-track-analogy-easy-to-remember)
  - [📖 Story to Remember:](#story-to-remember)
  - [🎯 Quick Decision Guide:](#quick-decision-guide)
- [🎤 Interview Questions](#interview-questions)
  - [Basic Questions](#basic-questions)
    - [Q1: What is the difference between Promise and Observable?](#q1-what-is-the-difference-between-promise-and-observable)
    - [Q2: Why is `toPromise()` deprecated in RxJS 7+?](#q2-why-is-topromise-deprecated-in-rxjs-7)
    - [Q3: What happens if one Promise in `Promise.all()` rejects?](#q3-what-happens-if-one-promise-in-promiseall-rejects)
    - [Q4: When would you use `Promise.race()`?](#q4-when-would-you-use-promiserace)
  - [Scenario-Based Questions](#scenario-based-questions)
    - [Scenario 1: Dashboard Loading](#scenario-1-dashboard-loading)
    - [Scenario 2: Multiple API Sources](#scenario-2-multiple-api-sources)
    - [Scenario 3: Request Timeout](#scenario-3-request-timeout)
    - [Scenario 4: Checkout Flow](#scenario-4-checkout-flow)
    - [Scenario 5: Fastest Server Selection](#scenario-5-fastest-server-selection)
  - [Advanced Questions](#advanced-questions)
    - [Q5: What's the difference between `Promise.race()` and `Promise.any()`?](#q5-whats-the-difference-between-promiserace-and-promiseany)
    - [Q6: How would you implement a retry with Promise?](#q6-how-would-you-implement-a-retry-with-promise)
    - [Q7: In a real Angular app, should you prefer Observables or Promises for HTTP?](#q7-in-a-real-angular-app-should-you-prefer-observables-or-promises-for-http)
- [💡 Pro Tips](#pro-tips)
