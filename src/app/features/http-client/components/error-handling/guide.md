...
- [✈️ Airplane Safety Analogy (Easy to Remember!)](#airplane-safety-analogy-easy-to-remember)
  - [📖 Story to Remember:](#story-to-remember)
  - [🎯 Error Codes as Flight Statuses:](#error-codes-as-flight-statuses)
- [2. 🚀 Implementation](#2--implementation)
  - [Basic catchError](#basic-catcherror)
  - [Retry with Exponential Backoff](#retry-with-exponential-backoff)
- [3. 🌍 Real World Uses](#3--real-world-uses)
- [4. ❓ Interview Questions](#4--interview-questions)
  - [Basic Questions](#basic-questions)
    - [Q1: What's the difference between catchError and retry?](#q1-whats-the-difference-between-catcherror-and-retry)
    - [Q2: Which HTTP error codes should you retry?](#q2-which-http-error-codes-should-you-retry)
    - [Q3: What is exponential backoff?](#q3-what-is-exponential-backoff)
  - [Scenario-Based Questions](#scenario-based-questions)
    - [Scenario 1: Show User-Friendly Error](#scenario-1-show-user-friendly-error)
    - [Scenario 2: Retry Only Server Errors](#scenario-2-retry-only-server-errors)
    - [Scenario 3: Offline Fallback](#scenario-3-offline-fallback)
    - [Scenario 4: Circuit Breaker](#scenario-4-circuit-breaker)
  - [Advanced Questions](#advanced-questions)
    - [Q4: What is "jitter" in retry strategies?](#q4-what-is-jitter-in-retry-strategies)
    - [Q5: How do you distinguish between network errors and server errors?](#q5-how-do-you-distinguish-between-network-errors-and-server-errors)
- [🧠 Mind Map](#mind-map)
