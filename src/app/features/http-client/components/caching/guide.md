...
- [📚 Library Analogy (Easy to Remember!)](#library-analogy-easy-to-remember)
...
- [4. ❓ Interview Questions](#4--interview-questions)
  - [Basic Questions](#basic-questions)
    - [Q1: How does shareReplay(1) work?](#q1-how-does-sharereplay1-work)
    - [Q2: When should you invalidate the cache?](#q2-when-should-you-invalidate-the-cache)
  - [Scenario-Based Questions](#scenario-based-questions)
    - [Scenario 1: Multiple Components Need Same Data](#scenario-1-multiple-components-need-same-data)
    - [Scenario 2: Cache with Expiration](#scenario-2-cache-with-expiration)
- [🧠 Mind Map](#mind-map)
