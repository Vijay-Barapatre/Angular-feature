...
- [🔄 SSR vs SSG Comparison](#ssr-vs-ssg-comparison)
  - [Key Differences](#key-differences)
- [⚡ When to Use Prerendering](#when-to-use-prerendering)
  - [✅ Great Use Cases](#great-use-cases)
  - [❌ Not Recommended](#not-recommended)
- [💻 Configuring Prerendering](#configuring-prerendering)
  - [Step 1: angular.json Configuration](#step-1-angularjson-configuration)
  - [Step 2: Run Prerender Build](#step-2-run-prerender-build)
  - [Step 3: Output Structure](#step-3-output-structure)
- [🔧 Dynamic Route Prerendering](#dynamic-route-prerendering)
  - [Option 1: routes.txt File](#option-1-routestxt-file)
  - [Option 2: Route Discovery Script](#option-2-route-discovery-script)
- [🌐 Hybrid Approach: SSR + SSG](#hybrid-approach-ssr--ssg)
  - [Deployment Strategy](#deployment-strategy)
- [📊 Performance Comparison](#performance-comparison)
  - [Why SSG is Fastest](#why-ssg-is-fastest)
- [🔄 Incremental Static Regeneration (ISR)](#incremental-static-regeneration-isr)
- [📦 Deployment Options](#deployment-options)
  - [CDN/Static Hosting](#cdnstatic-hosting)
  - [Example: Netlify Deployment](#example-netlify-deployment)
- [⚠️ Common Pitfalls](#common-pitfalls)
  - [1. Forgetting Dynamic Data](#1-forgetting-dynamic-data)
  - [2. API Routes Not Available at Build](#2-api-routes-not-available-at-build)
  - [3. Missing Routes](#3-missing-routes)
...
```
┌─────────────────────────────────────────────────────────────┐
│  SSG (PRERENDERING): BUILD-TIME HTML GENERATION             │
│                                                             │
│   SSR vs SSG:                                               │
│   ┌───────────────────────────────────────────────────────┐ │
│   │ SSR: Request → Server renders → HTML (runtime)        │ │
│   │ SSG: ng build → HTML files → CDN → Instant! (build)   │ │
│   └───────────────────────────────────────────────────────┘ │
│                                                             │
...
│                                                             │
│   WHEN TO USE SSG:                                          │
│   ✅ Marketing, docs, blogs, product listings              │
│   ❌ Dashboards, search results, real-time data            │
│                                                             │
│   PERFORMANCE: TTFB ~20ms (vs SSR ~200ms, CSR ~500ms)      │
└─────────────────────────────────────────────────────────────┘
```

> **Key Takeaway**: SSG = fastest! HTML generated at build, served from CDN. Use for static content. Use SSR for dynamic/personalized content.
