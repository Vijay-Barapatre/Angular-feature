...
- [🤔 The Problem](#the-problem)
  - [Common Browser-Only APIs That Break SSR](#common-browser-only-apis-that-break-ssr)
- [💻 Solution: Platform Detection](#solution-platform-detection)
  - [Basic Usage](#basic-usage)
  - [The PLATFORM_ID Token](#the-platform_id-token)
- [📋 Common Patterns](#common-patterns)
  - [Pattern 1: Conditional Initialization](#pattern-1-conditional-initialization)
  - [Pattern 2: Platform-Safe Service](#pattern-2-platform-safe-service)
  - [Pattern 3: afterNextRender Hook (Angular 17+)](#pattern-3-afternextrender-hook-angular-17)
  - [Pattern 4: Conditional Template Rendering](#pattern-4-conditional-template-rendering)
- [🔧 Advanced Techniques](#advanced-techniques)
  - [Using Renderer2 Instead of DOM APIs](#using-renderer2-instead-of-dom-apis)
  - [Using DOCUMENT Token](#using-document-token)
- [⚠️ Common Pitfalls](#common-pitfalls)
  - [1. Checking Platform Too Late](#1-checking-platform-too-late)
  - [2. Memory Leaks with Subscriptions](#2-memory-leaks-with-subscriptions)
