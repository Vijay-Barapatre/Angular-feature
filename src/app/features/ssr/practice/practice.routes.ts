...
export const SSR_PRACTICE_ROUTES: Routes = [
    // Basic Exercises
    {
        ...
        loadComponent: () => import('./basic/exercise-1-platform-detection.component')
            .then(m => m.ExercisePlatformDetectionComponent)
    },
    {
        path: 'basic/exercise-2',
        loadComponent: () => import('./basic/exercise-2-safe-dom-access.component')
            .then(m => m.ExerciseSafeDomAccessComponent)
    },
    {
        path: 'basic/exercise-3',
        loadComponent: () => import('./basic/exercise-3-transfer-state.component')
            .then(m => m.ExerciseTransferStateComponent)
    },
    {
        path: 'basic/exercise-4',
        loadComponent: () => import('./basic/exercise-4-seo-meta-tags.component')
    ...
    // Complex Scenarios
    {
        ...
        loadComponent: () => import('./complex/scenario-1-ssr-data-service.component')
            .then(m => m.ScenarioSsrDataServiceComponent)
    },
    {
        path: 'complex/scenario-2',
        loadComponent: () => import('./complex/scenario-2-browser-only-component.component')
            .then(m => m.ScenarioBrowserOnlyComponentComponent)
    },
    {
        path: 'complex/scenario-3',
        loadComponent: () => import('./complex/scenario-3-seo-service.component')
            .then(m => m.ScenarioSeoServiceComponent)
    },
    {
        path: 'complex/scenario-4',
        loadComponent: () => import('./complex/scenario-4-hybrid-strategy.component')
