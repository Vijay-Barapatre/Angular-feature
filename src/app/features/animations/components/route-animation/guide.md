...
- [🏛️ What Problem Does It Solve?](#what-problem-does-it-solve)
  - [The "Jarring Navigation" Problem](#the-jarring-navigation-problem)
  - [The Route Animation Solution](#the-route-animation-solution)
- [🔬 Core Concepts](#core-concepts)
  - [Components Involved](#components-involved)
- [📊 Route Animation Flow](#route-animation-flow)
- [🚀 Complete Implementation](#complete-implementation)
  - [Step 1: Define Animation Trigger](#step-1-define-animation-trigger)
  - [Step 2: Configure Routes with Animation Data](#step-2-configure-routes-with-animation-data)
  - [Step 3: Apply to App Component](#step-3-apply-to-app-component)
- [🎨 Animation Patterns](#animation-patterns)
  - [1. Slide Animation](#1-slide-animation)
  - [2. Fade Animation](#2-fade-animation)
  - [3. Scale Animation](#3-scale-animation)
  - [4. Directional (Based on Route Order)](#4-directional-based-on-route-order)
- [📦 Visual Box Diagram](#visual-box-diagram)
- [🐛 Common Pitfalls](#common-pitfalls)
  - [❌ Pitfall 1: Height Collapse](#pitfall-1-height-collapse)
  - [❌ Pitfall 2: Overflow Issues](#pitfall-2-overflow-issues)
  - [❌ Pitfall 3: Animation Not Triggering](#pitfall-3-animation-not-triggering)
- [❓ Interview Questions](#interview-questions)
  - [Q1: How do you access the current route's animation data?](#q1-how-do-you-access-the-current-routes-animation-data)
  - [Q2: Why do entering and leaving components need absolute positioning?](#q2-why-do-entering-and-leaving-components-need-absolute-positioning)
  - [Q3: What is the `group()` function for?](#q3-what-is-the-group-function-for)
  - [Q4: How do you animate based on navigation direction?](#q4-how-do-you-animate-based-on-navigation-direction)
- [🧠 Mind Map](#mind-map)
- [🚂 Train Analogy](#train-analogy)
  - [Story:](#story)
