...
## 📋 Table of Contents
- [1. 🔍 What is ngOnInit?](#1--what-is-ngoninit)
- [2. 🚀 Constructor vs ngOnInit](#2--constructor-vs-ngoninit)
  - [📦 Data Flow Summary (Visual Box Diagram)](#data-flow-summary-visual-box-diagram)
- [3. ❓ Interview Questions](#3--interview-questions)
  - [Basic Questions](#basic-questions)
    - [Q1: Why not put initialization in constructor?](#q1-why-not-put-initialization-in-constructor)
    - [Q2: How many times does ngOnInit run?](#q2-how-many-times-does-ngoninit-run)
    - [Q3: What hooks run before ngOnInit?](#q3-what-hooks-run-before-ngoninit)
  - [Scenario-Based Questions](#scenario-based-questions)
    - [Scenario: Inputs in Constructor](#scenario-inputs-in-constructor)
- [👶 Baby Growing Up Analogy (Easy to Remember!)](#baby-growing-up-analogy-easy-to-remember)
  - [📖 Story to Remember:](#story-to-remember)
  - [🎯 Quick Reference:](#quick-reference)
- [🧠 Mind Map](#mind-map)
- [🎯 What Problem Does This Solve?](#what-problem-does-this-solve)
  - [The Problem: Initialization Logic in Wrong Place](#the-problem-initialization-logic-in-wrong-place)
  - [How ngOnInit Solves This](#how-ngoninit-solves-this)
- [📚 Key Concepts Explained](#key-concepts-explained)
  - [1. `OnInit` Interface](#1-oninit-interface)
  - [2. Lifecycle Order](#2-lifecycle-order)
  - [3. When ngOnInit Runs](#3-when-ngoninit-runs)
- [🌍 Real-World Use Cases](#real-world-use-cases)
  - [1. Fetching Data on Component Load](#1-fetching-data-on-component-load)
  - [2. Setting Up Subscriptions](#2-setting-up-subscriptions)
  - [3. Computing Derived State](#3-computing-derived-state)
  - [4. Form Initialization](#4-form-initialization)
  - [5. Third-Party Library Setup](#5-third-party-library-setup)
