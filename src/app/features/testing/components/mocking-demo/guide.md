...
- [2. 🚀 Implementation](#2--implementation)
  - [Step 1: Create Spy Object](#step-1-create-spy-object)
  - [Step 2: Configure Return Values](#step-2-configure-return-values)
  - [Step 3: Provide in TestBed](#step-3-provide-in-testbed)
  - [Step 4: Verify Calls](#step-4-verify-calls)
- [2.1 🎭 Understanding Mocking - Deep Dive](#21--understanding-mocking---deep-dive)
  - [What is Mocking?](#what-is-mocking)
  - [Why Mock? The Problem Without Mocking](#why-mock-the-problem-without-mocking)
  - [Real-World Comparison](#real-world-comparison)
- [2.2 🔧 Understanding jasmine.createSpyObj()](#22--understanding-jasminecreatespyobj)
  - [What is jasmine.createSpyObj()?](#what-is-jasminecreatespyobj)
    - [Syntax](#syntax)
    - [What it Creates](#what-it-creates)
    - [Three Parameters](#three-parameters)
  - [The Complete Mocking Flow](#the-complete-mocking-flow)
- [2.3 📝 Step-by-Step: Creating & Using Mocks](#23--step-by-step-creating--using-mocks)
  - [Step 1: Create the Mock](#step-1-create-the-mock)
  - [Step 2: Configure Return Values](#step-2-configure-return-values)
    - [Configuration Options](#configuration-options)
  - [Step 3: Provide in TestBed](#step-3-provide-in-testbed)
  - [Step 4: Test & Verify](#step-4-test--verify)
- [2.4 🔍 Spy Verification Matchers](#24--spy-verification-matchers)
  - [Basic Verification](#basic-verification)
  - [Advanced Verification](#advanced-verification)
- [2.5 🎯 Common Mocking Patterns](#25--common-mocking-patterns)
  - [Pattern 1: Success Scenario (Default)](#pattern-1-success-scenario-default)
  - [Pattern 2: Error Scenario (Override per Test)](#pattern-2-error-scenario-override-per-test)
  - [Pattern 3: Different Returns per Call](#pattern-3-different-returns-per-call)
  - [Pattern 4: Conditional Logic](#pattern-4-conditional-logic)
- [2.6 🚨 Provider Strategies: useValue vs useClass vs useFactory](#26--provider-strategies-usevalue-vs-useclass-vs-usefactory)
  - [When to Use Each](#when-to-use-each)
- [2.7 ⚡ Testing Async with fakeAsync & tick](#27--testing-async-with-fakeasync--tick)
  - [What are fakeAsync & tick?](#what-are-fakeasync--tick)
- [2.8 🧠 Memory Tricks](#28--memory-tricks)
  - [Stunt Double Analogy 🎬](#stunt-double-analogy)
  - [Quick Decision Tree](#quick-decision-tree)
- [3. 🐛 Common Pitfalls](#3--common-pitfalls)
- [4. ⚡ Reusable Mock Pattern](#4--reusable-mock-pattern)
- [5. ❓ Interview Questions](#5--interview-questions)
- [❓ Additional Interview Questions (20+)](#additional-interview-questions-20)
- [🧠 Mind Map](#mind-map)
- [🎬 Stunt Double Analogy (Easy to Remember!)](#stunt-double-analogy-easy-to-remember)
