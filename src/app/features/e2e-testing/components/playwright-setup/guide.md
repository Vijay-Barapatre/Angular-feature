...
- [2. 🚀 Installation & Setup](#2--installation--setup)
  ...
  - [Step 3: First Test](#step-3-first-test)
- [3. 📊 Configuration Options Explained](#3--configuration-options-explained)
  - [Test Directory Structure](#test-directory-structure)
  - [Key Config Properties](#key-config-properties)
- [4. 🎯 Running Tests](#4--running-tests)
  - [CLI Commands](#cli-commands)
- [5. 🔬 Browser Contexts & Pages](#5--browser-contexts--pages)
  - [Browser vs Context vs Page](#browser-vs-context-vs-page)
  - [Multiple Pages Example](#multiple-pages-example)
- [6. 🌍 Real-World Use Cases](#6--real-world-use-cases)
  - [CI/CD Pipeline](#cicd-pipeline)
  - [Mobile Testing](#mobile-testing)
  - [Authentication State](#authentication-state)
- [7. 🐛 Common Pitfalls](#7--common-pitfalls)
  - [❌ Not Installing Browsers](#not-installing-browsers)
  - [❌ Wrong Base URL](#wrong-base-url)
  - [❌ Forgetting to Start Server](#forgetting-to-start-server)
- [❓ Complete Interview Questions (25+)](#complete-interview-questions-25)
  ...
  - [Browser & Context Questions](#browser--context-questions)
  - [Mobile & Device Questions](#mobile--device-questions)
  - [Web Server Questions](#web-server-questions)
  - [Running Tests Questions](#running-tests-questions)
