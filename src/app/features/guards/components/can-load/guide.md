...
- [🆚 canLoad vs canActivate](#canload-vs-canactivate)
- [💡 Real-World Use Cases](#real-world-use-cases)
- [📝 Implementation](#implementation)
  - [1. Create the Guard](#1-create-the-guard)
  - [2. Apply to Lazy-Loaded Route](#2-apply-to-lazy-loaded-route)
- [⚠️ Important Notes](#important-notes)
  - [📦 Data Flow Summary (Visual Box Diagram)](#data-flow-summary-visual-box-diagram)
- [🔐 Security Consideration](#security-consideration)
- [🔐 Treasure Vault Analogy (Easy to Remember!)](#treasure-vault-analogy-easy-to-remember)
