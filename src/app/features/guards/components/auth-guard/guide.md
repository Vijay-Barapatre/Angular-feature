...
- [1. 🔍 How It Works (The Concept)](#1--how-it-works-the-concept)
  ...
  - [📊 Guard Flow](#guard-flow)
  - [📦 Data Flow Summary (Visual Box Diagram)](#data-flow-summary-visual-box-diagram)
- [2. 🚀 Step-by-Step Implementation](#2--step-by-step-implementation)
  - [Step 1: The Functional Guard](#step-1-the-functional-guard)
  - [Step 2: Registering in Routes](#step-2-registering-in-routes)
- [🔧 Implementation Flow Mindmap](#implementation-flow-mindmap)
- [🚪 Nightclub Bouncer Analogy (Easy to Remember!)](#nightclub-bouncer-analogy-easy-to-remember)
  - [📖 Story to Remember:](#story-to-remember)
  - [🎯 Quick Reference:](#quick-reference)
- [3. 🧠 Mind Map: Quick Visual Reference](#3--mind-map-quick-visual-reference)
- [🎯 What Problem Does This Solve?](#what-problem-does-this-solve)
  - [The Problem: Unprotected Routes Allow Unauthorized Access](#the-problem-unprotected-routes-allow-unauthorized-access)
  - [How Guards Solve This](#how-guards-solve-this)
- [📚 Key Types & Patterns Explained](#key-types--patterns-explained)
  - [1. `CanActivateFn` Type (Functional Guard)](#1-canactivatefn-type-functional-guard)
  - [2. `inject()` in Guards](#2-inject-in-guards)
  - [3. `UrlTree` for Redirects](#3-urltree-for-redirects)
  - [4. Composable Guards](#4-composable-guards)
- [🌍 Real-World Use Cases](#real-world-use-cases)
  - [1. Authentication Guard](#1-authentication-guard)
  - [2. Role-Based Access Guard](#2-role-based-access-guard)
  - [3. Feature Flag Guard](#3-feature-flag-guard)
  - [4. Subscription Guard](#4-subscription-guard)
  - [5. Onboarding Complete Guard](#5-onboarding-complete-guard)
- [❓ Complete Interview Questions (25+)](#complete-interview-questions-25)
  ...
  - [Async Guard Questions](#async-guard-questions)
