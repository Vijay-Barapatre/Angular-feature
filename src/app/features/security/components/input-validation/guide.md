...
- [🚰 Water Filter Analogy (Easy to Remember!)](#water-filter-analogy-easy-to-remember)
...
- [3. ❓ Interview Questions](#3--interview-questions)
  - [Basic Questions](#basic-questions)
    - [Q1: Why is client-side validation not enough?](#q1-why-is-client-side-validation-not-enough)
    - [Q2: What's the difference between sanitization and validation?](#q2-whats-the-difference-between-sanitization-and-validation)
  - [Scenario-Based Questions](#scenario-based-questions)
    - [Scenario 1: SQL Injection Prevention](#scenario-1-sql-injection-prevention)
    - [Scenario 2: File Upload Validation](#scenario-2-file-upload-validation)
