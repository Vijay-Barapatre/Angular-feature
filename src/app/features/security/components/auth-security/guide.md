...
- [3. ❓ Interview Questions](#3--interview-questions)
  - [Basic Questions](#basic-questions)
    - [Q1: Why shouldn't you store JWTs in localStorage?](#q1-why-shouldnt-you-store-jwts-in-localstorage)
    - [Q2: What's the difference between authentication and authorization?](#q2-whats-the-difference-between-authentication-and-authorization)
  - [Scenario-Based Questions](#scenario-based-questions)
    - [Scenario 1: Silent Token Refresh](#scenario-1-silent-token-refresh)
    - [Scenario 2: Remember Me](#scenario-2-remember-me)
  - [📦 Data Flow Summary (Visual Box Diagram)](#data-flow-summary-visual-box-diagram)
- [🏦 Vault vs. Wallet Analogy (Easy to Remember!)](#vault-vs-wallet-analogy-easy-to-remember)
- [🧠 Mind Map](#mind-map)
