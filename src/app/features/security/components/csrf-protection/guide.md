...
- [2. 🚀 Protection Strategies](#2--protection-strategies)
  - [CSRF Tokens](#csrf-tokens)
  - [SameSite Cookies](#samesite-cookies)
- [3. ❓ Interview Questions](#3--interview-questions)
  - [Basic Questions](#basic-questions)
    - [Q1: How does CSRF differ from XSS?](#q1-how-does-csrf-differ-from-xss)
    - [Q2: How does Angular protect against CSRF?](#q2-how-does-angular-protect-against-csrf)
  - [Scenario-Based Questions](#scenario-based-questions)
    - [Scenario 1: API Without Cookie Auth](#scenario-1-api-without-cookie-auth)
    - [Scenario 2: Custom CSRF Header](#scenario-2-custom-csrf-header)
