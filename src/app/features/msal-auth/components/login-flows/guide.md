...
- [2. 🚀 Protected Resources](#2--protected-resources)
- [3. ❓ Interview Questions](#3--interview-questions)
  - [Basic Questions](#basic-questions)
    - [Q1: clientId vs tenantId?](#q1-clientid-vs-tenantid)
    - [Q2: localStorage vs sessionStorage for cache?](#q2-localstorage-vs-sessionstorage-for-cache)
  - [Scenario-Based Questions](#scenario-based-questions)
    - [Scenario: Multi-tenant App](#scenario-multi-tenant-app)
