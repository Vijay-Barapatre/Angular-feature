...
## 📋 Table of Contents
- [1. 🔍 Interceptor Setup](#1--interceptor-setup)
- [2. 🚀 How It Works](#2--how-it-works)
- [3. ❓ Interview Questions](#3--interview-questions)
  - [Basic Questions](#basic-questions)
    - [Q1: What is protectedResourceMap?](#q1-what-is-protectedresourcemap)
    - [Q2: Silent vs Interactive token acquisition?](#q2-silent-vs-interactive-token-acquisition)
  - [Scenario-Based Questions](#scenario-based-questions)
    - [Scenario: Multiple APIs](#scenario-multiple-apis)
