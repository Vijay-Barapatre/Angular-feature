...
- [1. 🔍 Login Methods](#1--login-methods)
  - [Popup Login (Smoother UX)](#popup-login-smoother-ux)
  - [Redirect Login (More reliable)](#redirect-login-more-reliable)
- [2. 🚀 Logout](#2--logout)
- [3. ❓ Interview Questions](#3--interview-questions)
  - [Basic Questions](#basic-questions)
    - [Q1: Popup vs Redirect - when use which?](#q1-popup-vs-redirect---when-use-which)
    - [Q2: What are scopes?](#q2-what-are-scopes)
  - [Scenario-Based Questions](#scenario-based-questions)
    - [Scenario: Silent Login Check](#scenario-silent-login-check)
