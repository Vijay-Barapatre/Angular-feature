# 🛡️ Route Guards with MSAL

> **💡 Lightbulb Moment**: Use MsalGuard to protect routes - automatic redirect to login if not authenticated!


## 📋 Table of Contents
- [1. 🔍 MsalGuard Setup](#1--msalguard-setup)
- [2. 🚀 Guard Configuration](#2--guard-configuration)
- [3. ❓ Interview Questions](#3--interview-questions)
  - [Basic Questions](#basic-questions)
    - [Q1: What happens when MsalGuard blocks?](#q1-what-happens-when-msalguard-blocks)
    - [Q2: How to protect child routes?](#q2-how-to-protect-child-routes)
  - [Scenario-Based Questions](#scenario-based-questions)
    - [Scenario: Role-Based Access](#scenario-role-based-access)
