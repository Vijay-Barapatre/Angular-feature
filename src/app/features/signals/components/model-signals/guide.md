...
## 📋 Table of Contents
- [1. 🔍 What are Signal Outputs?](#1--what-are-signal-outputs)
- [2. 🚀 Comparison](#2--comparison)
  - [📊 Data Flow Diagram](#data-flow-diagram)
  - [📦 Data Flow Summary (Visual Box Diagram)](#data-flow-summary-visual-box-diagram)
- [3. ❓ Interview Questions](#3--interview-questions)
  - [Basic Questions](#basic-questions)
    - [Q1: output() vs @Output - what's different?](#q1-output-vs-output---whats-different)
  - [Scenario-Based Questions](#scenario-based-questions)
    - [Scenario: Modal Component](#scenario-modal-component)
- [🧠 Mind Map](#mind-map)
- [🎯 What Problem Does This Solve?](#what-problem-does-this-solve)
  - [The Problem: @Output + EventEmitter Is Verbose](#the-problem-output--eventemitter-is-verbose)
  - [How Signal Outputs Solve This](#how-signal-outputs-solve-this)
- [📚 Key Classes & Types Explained](#key-classes--types-explained)
  - [1. `output<T>()` Function](#1-outputt-function)
  - [2. `OutputEmitterRef<T>` Type](#2-outputemitterreft-type)
  - [3. Output Options](#3-output-options)
- [🌍 Real-World Use Cases](#real-world-use-cases)
  - [1. Custom Button](#1-custom-button)
  - [2. Modal with Multiple Outputs](#2-modal-with-multiple-outputs)
  - [3. Autocomplete Component](#3-autocomplete-component)
  - [4. Pagination Component](#4-pagination-component)
  - [5. File Upload Component](#5-file-upload-component)
