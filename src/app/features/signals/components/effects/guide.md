...
## 📋 Table of Contents
- [1. 🔍 What is effect()?](#1--what-is-effect)
- [2. 🚀 Common Use Cases](#2--common-use-cases)
  - [Logging/Analytics](#logginganalytics)
...
- [3. ❓ Interview Questions](#3--interview-questions)
  - [Basic Questions](#basic-questions)
    - [Q1: effect() vs computed() - what's the difference?](#q1-effect-vs-computed---whats-the-difference)
    - [Q2: Can you use effect() outside components?](#q2-can-you-use-effect-outside-components)
  - [Scenario-Based Questions](#scenario-based-questions)
    - [Scenario: Auto-save Form](#scenario-auto-save-form)
- [🚨 Motion Sensor Analogy (Easy to Remember!)](#motion-sensor-analogy-easy-to-remember)
  - [📖 Story to Remember:](#story-to-remember)
  - [🎯 Quick Reference:](#quick-reference)
- [🧠 Mind Map](#mind-map)
- [🎯 What Problem Does This Solve?](#what-problem-does-this-solve)
  - [The Problem: Reacting to Changes Requires Manual Wiring](#the-problem-reacting-to-changes-requires-manual-wiring)
  - [How Effects Solve This](#how-effects-solve-this)
- [📚 Key Classes & Types Explained](#key-classes--types-explained)
  - [1. `effect()` Function](#1-effect-function)
  - [2. `EffectRef` Type](#2-effectref-type)
  - [3. Effect Options](#3-effect-options)
  - [4. Cleanup Function](#4-cleanup-function)
- [🌍 Real-World Use Cases](#real-world-use-cases)
  - [1. Persist to LocalStorage](#1-persist-to-localstorage)
  - [2. Sync Document Title](#2-sync-document-title)
