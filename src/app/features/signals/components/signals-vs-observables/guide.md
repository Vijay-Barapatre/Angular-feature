...
## 📋 Table of Contents
- [1. 🔍 Converting Between RxJS and Signals](#1--converting-between-rxjs-and-signals)
...
- [2. 🚀 toSignal Options](#2--tosignal-options)
  - [📊 Data Flow Diagram](#data-flow-diagram)
  - [📦 Data Flow Summary (Visual Box Diagram)](#data-flow-summary-visual-box-diagram)
- [3. ❓ Interview Questions](#3--interview-questions)
  - [Basic Questions](#basic-questions)
    - [Q1: When use toSignal?](#q1-when-use-tosignal)
    - [Q2: Does toSignal auto-unsubscribe?](#q2-does-tosignal-auto-unsubscribe)
  - [Scenario-Based Questions](#scenario-based-questions)
    - [Scenario: HTTP with Signals](#scenario-http-with-signals)
- [🧠 Mind Map](#mind-map)
- [🎯 What Problem Does This Solve?](#what-problem-does-this-solve)
  - [The Problem: Signals and RxJS Are Different Worlds](#the-problem-signals-and-rxjs-are-different-worlds)
  - [How Interop Solves This](#how-interop-solves-this)
- [📚 Key Classes & Types Explained](#key-classes--types-explained)
  - [1. `toSignal<T>()` Function](#1-tosignalt-function)
  - [2. toSignal Options](#2-tosignal-options)
  - [3. `toObservable<T>()` Function](#3-toobservablet-function)
  - [4. Injection Context Requirement](#4-injection-context-requirement)
- [🌍 Real-World Use Cases](#real-world-use-cases)
  - [1. HTTP Data to Signal](#1-http-data-to-signal)
  - [2. Store State to Signal](#2-store-state-to-signal)
  - [3. Route Params to Signal](#3-route-params-to-signal)
  - [4. Signal to Debounced Observable](#4-signal-to-debounced-observable)
  - [5. WebSocket to Signal](#5-websocket-to-signal)
