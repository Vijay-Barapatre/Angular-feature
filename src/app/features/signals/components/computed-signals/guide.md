...
## 📋 Table of Contents
- [1. 🔍 What are Computed Signals?](#1--what-are-computed-signals)
...
- [3. ❓ Interview Questions](#3--interview-questions)
  - [Basic Questions](#basic-questions)
    - [Q1: Can you modify a computed signal?](#q1-can-you-modify-a-computed-signal)
    - [Q2: When does computed recalculate?](#q2-when-does-computed-recalculate)
  - [Scenario-Based Questions](#scenario-based-questions)
    - [Scenario: Shopping Cart Total](#scenario-shopping-cart-total)
- [📊 Spreadsheet Formula Analogy (Easy to Remember!)](#spreadsheet-formula-analogy-easy-to-remember)
  - [📖 Story to Remember:](#story-to-remember)
  - [🎯 Quick Reference:](#quick-reference)
- [🧠 Mind Map](#mind-map)
- [🎯 What Problem Does This Solve?](#what-problem-does-this-solve)
  - [The Problem: Derived State Gets Out of Sync](#the-problem-derived-state-gets-out-of-sync)
  - [How Computed Signals Solve This](#how-computed-signals-solve-this)
- [📚 Key Classes & Types Explained](#key-classes--types-explained)
  - [1. `computed<T>()` Function](#1-computedt-function)
  - [2. Computation Function](#2-computation-function)
  - [3. Dependency Graph](#3-dependency-graph)
- [🌍 Real-World Use Cases](#real-world-use-cases)
  - [1. Shopping Cart Totals](#1-shopping-cart-totals)
  - [2. Form Validation](#2-form-validation)
  - [3. Filtered & Sorted Lists](#3-filtered--sorted-lists)
  - [4. UI State Derivation](#4-ui-state-derivation)
  - [5. Chained Computations](#5-chained-computations)
- [❓ Complete Interview Questions (20+)](#complete-interview-questions-20)
  ...
  - [Debug & Performance Questions](#debug--performance-questions)
