...
- [1. 🎯 What Problem Does It Solve?](#1--what-problem-does-it-solve)
  - [The Problem: Router and Store are Disconnected](#the-problem-router-and-store-are-disconnected)
  - [How Router Store Solves This](#how-router-store-solves-this)
- [2. 🚀 Setup & Configuration](#2--setup--configuration)
  - [Installation](#installation)
  - [Basic Configuration](#basic-configuration)
  - [Custom Serializer (Recommended)](#custom-serializer-recommended)
- [3. 📚 Key API & Patterns](#3--key-api--patterns)
  - [1. Router Selectors](#1-router-selectors)
  - [2. Router Actions](#2-router-actions)
  - [3. Navigation via Actions/Effects](#3-navigation-via-actionseffects)
- [4. 🌍 Real-World Use Cases](#4--real-world-use-cases)
  - [1. Route-Driven Data Loading](#1-route-driven-data-loading)
  - [2. Query Param Filtering](#2-query-param-filtering)
  - [3. Pagination State in URL](#3-pagination-state-in-url)
  - [4. Authentication Guard with Route Redirect](#4-authentication-guard-with-route-redirect)
...
- [❓ Complete Interview Questions (20+)](#complete-interview-questions-20)
  ...
  - [Integration with Effects](#integration-with-effects)
  - [Selectors Questions](#selectors-questions)
  - [Scenario Questions](#scenario-questions)
  - [Advanced Questions](#advanced-questions)
- [🧠 Quick Reference](#quick-reference)
  - [Router State in Store](#router-state-in-store)
