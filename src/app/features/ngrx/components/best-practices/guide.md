...
- [1. 🔍 Core Patterns](#1--core-patterns)
  - [Pattern 1: Action Triad](#pattern-1-action-triad)
  - [Pattern 2: Facade Service](#pattern-2-facade-service)
  - [Pattern 3: Smart & Dumb Components](#pattern-3-smart--dumb-components)
- [2. ❌ Anti-Patterns to Avoid](#2--anti-patterns-to-avoid)
  - [Anti-Pattern 1: State Mutation](#anti-pattern-1-state-mutation)
  - [Anti-Pattern 2: Missing catchError](#anti-pattern-2-missing-catcherror)
- [3. ❓ Interview Questions](#3--interview-questions)
  - [Basic Questions](#basic-questions)
    - [Q1: What are the three principles of Redux/NgRx?](#q1-what-are-the-three-principles-of-reduxngrx)
    - [Q2: When should you NOT use NgRx?](#q2-when-should-you-not-use-ngrx)
  - [Scenario-Based Questions](#scenario-based-questions)
    - [Scenario 1: Large Feature Module](#scenario-1-large-feature-module)
    - [Scenario 2: Optimistic Updates](#scenario-2-optimistic-updates)
    - [Scenario 3: Testing Strategy](#scenario-3-testing-strategy)
- [🧠 Mind Map](#mind-map)
- [🎯 What Problem Does This Solve?](#what-problem-does-this-solve)
  - [The Problem: NgRx Without Conventions Is Chaos](#the-problem-ngrx-without-conventions-is-chaos)
  - [How Best Practices Solve This](#how-best-practices-solve-this)
- [📚 Key Patterns Explained](#key-patterns-explained)
  - [1. Action Naming Convention](#1-action-naming-convention)
  - [2. Facade Pattern](#2-facade-pattern)
  - [3. Smart & Dumb Component Architecture](#3-smart--dumb-component-architecture)
  - [4. Normalized State (Entity Pattern)](#4-normalized-state-entity-pattern)
  - [5. Feature Module Organization](#5-feature-module-organization)
- [🌍 Real-World Use Cases](#real-world-use-cases)
  ...
  - [5. Optimistic UI with Rollback](#5-optimistic-ui-with-rollback)
- [❓ Complete Interview Questions (20+)](#complete-interview-questions-20)
  - [Core Principles](#core-principles)
  - [Pattern Questions](#pattern-questions)
  - [Anti-Pattern Questions](#anti-pattern-questions)
