...
## 📋 Table of Contents
- [1. 🔍 What DevTools Provides](#1--what-devtools-provides)
...
- [3. ❓ Interview Questions](#3--interview-questions)
  - [Basic Questions](#basic-questions)
    - [Q1: What is Redux DevTools?](#q1-what-is-redux-devtools)
    - [Q2: Why use logOnly in production?](#q2-why-use-logonly-in-production)
    - [Q3: What does maxAge control?](#q3-what-does-maxage-control)
  - [Scenario-Based Questions](#scenario-based-questions)
    - [Scenario 1: Debugging a Bug](#scenario-1-debugging-a-bug)
    - [Scenario 2: Reproduce Production Issue](#scenario-2-reproduce-production-issue)
    - [Scenario 3: Performance Investigation](#scenario-3-performance-investigation)
    - [Scenario 4: State Sanitization](#scenario-4-state-sanitization)
  - [Advanced Questions](#advanced-questions)
    - [Q4: How does time-travel work technically?](#q4-how-does-time-travel-work-technically)
    - [Q5: Can you dispatch actions from DevTools?](#q5-can-you-dispatch-actions-from-devtools)
- [🧠 Mind Map](#mind-map)
- [🎯 What Problem Does This Solve?](#what-problem-does-this-solve)
  - [The Problem: Debugging State is Nearly Impossible](#the-problem-debugging-state-is-nearly-impossible)
  - [How DevTools Solve This](#how-devtools-solve-this)
- [📚 Key Classes & Types Explained](#key-classes--types-explained)
  - [1. `provideStoreDevtools()` (from `@ngrx/store-devtools`)](#1-providestoredevtools-from-ngrxstore-devtools)
  - [2. `stateSanitizer` Function](#2-statesanitizer-function)
  - [3. `actionSanitizer` Function](#3-actionsanitizer-function)
  - [4. `serialize` Option](#4-serialize-option)
  - [5. DevTools Extension API](#5-devtools-extension-api)
- [🌍 Real-World Use Cases](#real-world-use-cases)
  - [1. Bug Investigation Workflow](#1-bug-investigation-workflow)
  - [2. QA Reproducible Test Cases](#2-qa-reproducible-test-cases)
  - [3. Performance Monitoring](#3-performance-monitoring)
  - [4. State Size Monitoring](#4-state-size-monitoring)
  - [5. Cross-Browser Debugging](#5-cross-browser-debugging)
