...
- [🔍 How It Works (The Concept)](#how-it-works-the-concept)
  - [Mermaid Diagram: Navigation Flow](#mermaid-diagram-navigation-flow)
- [🚀 Step-by-Step Implementation Guide](#step-by-step-implementation-guide)
  - [1. Inject the RouterService](#1-inject-the-routerservice)
  - [2. Navigate with `navigate()` (Array Syntax)](#2-navigate-with-navigate-array-syntax)
  - [3. Navigate with `navigateByUrl()` (String Syntax)](#3-navigate-with-navigatebyurl-string-syntax)
- [🐛 Common Pitfalls & Debugging](#common-pitfalls--debugging)
  - [1. `this` Context](#1-this-context)
  - [2. Relative Navigation Error](#2-relative-navigation-error)
