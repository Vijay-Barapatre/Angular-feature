...
## 📋 Table of Contents
- [1. 🔍 What is runOutsideAngular?](#1--what-is-runoutsideangular)
...
- [🎯 What Problem Does This Solve?](#what-problem-does-this-solve)
  - [The Problem: Change Detection Spam](#the-problem-change-detection-spam)
  - [How runOutsideAngular Solves This](#how-runoutsideangular-solves-this)
- [📚 Key Classes & Types Explained](#key-classes--types-explained)
  - [1. `runOutsideAngular(fn)`](#1-runoutsideangularfn)
  - [2. `run(fn)`](#2-runfn)
- [🌍 Real-World Use Cases](#real-world-use-cases)
  - [1. High-Frequency DOM Events](#1-high-frequency-dom-events)
  - [2. Canvas / WebGL Rendering](#2-canvas--webgl-rendering)
  - [3. Analytics / Logging "Beacons"](#3-analytics--logging-beacons)
  - [4. WebSocket Data Stream](#4-websocket-data-stream)
