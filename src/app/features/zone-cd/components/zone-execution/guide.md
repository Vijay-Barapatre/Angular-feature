...
- [3. ❓ Interview Questions](#3--interview-questions)
  - [Basic Questions](#basic-questions)
    - [Q1: Why does Angular use Zone.js?](#q1-why-does-angular-use-zonejs)
    - [Q2: What async operations does Zone.js patch?](#q2-what-async-operations-does-zonejs-patch)
  - [Scenario-Based Questions](#scenario-based-questions)
    - [Scenario: Why doesn't my view update?](#scenario-why-doesnt-my-view-update)
