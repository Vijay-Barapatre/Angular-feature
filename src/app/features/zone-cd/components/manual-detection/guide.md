...
## 📋 Table of Contents
- [1. 🔍 ChangeDetectorRef Methods](#1--changedetectorref-methods)
- [2. 🚀 Common Patterns](#2--common-patterns)
  - [After async operation (OnPush)](#after-async-operation-onpush)
  - [Force immediate update](#force-immediate-update)
  - [📊 Data Flow Diagram](#data-flow-diagram)
  - [📦 Data Flow Summary (Visual Box Diagram)](#data-flow-summary-visual-box-diagram)
- [🎯 What Problem Does This Solve?](#what-problem-does-this-solve)
  - [The Problem: Angular is too Automatic (or too slow)](#the-problem-angular-is-too-automatic-or-too-slow)
  - [How Manual CD Solves This](#how-manual-cd-solves-this)
- [📚 Key Classes & Types Explained](#key-classes--types-explained)
  - [1. `ChangeDetectorRef`](#1-changedetectorref)
  - [2. `ApplicationRef.tick()`](#2-applicationreftick)
- [🌍 Real-World Use Cases](#real-world-use-cases)
  - [1. Complex Forms with OnPush](#1-complex-forms-with-onpush)
  - [2. Virtual Scrolling](#2-virtual-scrolling)
  - [3. Modal / Pop-ups initiated completely outside Angular](#3-modal--pop-ups-initiated-completely-outside-angular)
