...
- [2. 🚀 Step-by-Step Implementation](#2--step-by-step-implementation)
  - [Step 1: Loops and Naming](#step-1-loops-and-naming)
  - [Step 2: Adding/Removing Logic](#step-2-addingremoving-logic)
  - [Step 3: TrackBy Function](#step-3-trackby-function)
  - [📦 Data Flow Summary (Visual Box Diagram)](#data-flow-summary-visual-box-diagram)
- [3. Deep Dive: Loop & TrackBy Mechanics](#3-deep-dive-loop--trackby-mechanics)
  - [A. How the Loop Works (`*ngFor`)](#a-how-the-loop-works-ngfor)
  - [B. The "Focus Loss" Problem (Why you need `trackBy`)](#b-the-focus-loss-problem-why-you-need-trackby)
  - [C. How `trackBy` Fixes It](#c-how-trackby-fixes-it)
- [4. 🧠 Mind Map: Quick Visual Reference](#4--mind-map-quick-visual-reference)
