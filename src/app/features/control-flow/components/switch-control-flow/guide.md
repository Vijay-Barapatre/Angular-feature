...
- [🏛️ What Problem Does It Solve?](#what-problem-does-it-solve)
  - [The Old Way (*ngSwitch)](#the-old-way-ngswitch)
  - [The New Way (@switch)](#the-new-way-switch)
- [🔬 Syntax Reference](#syntax-reference)
  - [Basic @switch](#basic-switch)
  - [With Type Literals](#with-type-literals)
  - [With Numbers](#with-numbers)
- [📊 Comparison Table](#comparison-table)
- [📦 Visual Comparison](#visual-comparison)
- [🐛 Common Pitfalls](#common-pitfalls)
  - [❌ Pitfall 1: Missing Parentheses](#pitfall-1-missing-parentheses)
  - [❌ Pitfall 2: Wrong Case Syntax](#pitfall-2-wrong-case-syntax)
  - [❌ Pitfall 3: Trying Fall-Through](#pitfall-3-trying-fall-through)
- [🎯 Real-World Examples](#real-world-examples)
  - [HTTP Status Display](#http-status-display)
  - [Theme Switcher](#theme-switcher)
  - [Wizard Steps](#wizard-steps)
- [❓ Interview Questions](#interview-questions)
  - [Q1: When should you use @switch vs @if/@else if?](#q1-when-should-you-use-switch-vs-ifelse-if)
  - [Q2: Does @switch support fall-through like JavaScript switch?](#q2-does-switch-support-fall-through-like-javascript-switch)
  - [Q3: Is @default required?](#q3-is-default-required)
  - [Q4: Can you use expressions in @case?](#q4-can-you-use-expressions-in-case)
- [🧠 Mind Map](#mind-map)
- [🚂 Train Station Analogy](#train-station-analogy)
  - [Story:](#story)
