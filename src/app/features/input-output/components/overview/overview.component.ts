    ...
    useCases = [
        {
            ...
            route: '/input-output/basic-input-output',
        ...
        },
        {
            ...
            route: '/input-output/two-way-binding',
        ...
        },
        {
            ...
            route: '/input-output/complex-objects',
        ...
        },
        {
            ...
            route: '/input-output/custom-events',
        ...
        },
        {
            ...
            route: '/input-output/input-transforms',
        ...
        },
        {
            ...
            route: '/input-output/multiple-inputs-outputs',
