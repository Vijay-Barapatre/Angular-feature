...
## 📋 Table of Contents
- [1. 🔍 localStorage Caching](#1--localstorage-caching)
- [2. 🚀 Pros and Cons](#2--pros-and-cons)
- [3. ❓ Interview Questions](#3--interview-questions)
  - [Basic Questions](#basic-questions)
    - [Q1: localStorage vs sessionStorage?](#q1-localstorage-vs-sessionstorage)
    - [Q2: Security concerns?](#q2-security-concerns)
  - [Scenario-Based Questions](#scenario-based-questions)
    - [Scenario: Offline-First Cache](#scenario-offline-first-cache)
  - [📦 Data Flow Summary (Visual Box Diagram)](#data-flow-summary-visual-box-diagram)
- [🥫 Pantry Shelf Analogy (Easy to Remember!)](#pantry-shelf-analogy-easy-to-remember)
