...
## 📋 Table of Contents
- [1. 🔍 Cache Invalidation Strategies](#1--cache-invalidation-strategies)
  - [Time-Based (TTL)](#time-based-ttl)
  - [Event-Based](#event-based)
  - [Manual Refresh](#manual-refresh)
- [2. ❓ Interview Questions](#2--interview-questions)
  - [Basic Questions](#basic-questions)
    - [Q1: What are cache invalidation strategies?](#q1-what-are-cache-invalidation-strategies)
    - [Q2: "Cache invalidation is one of the hardest problems" - why?](#q2-cache-invalidation-is-one-of-the-hardest-problems---why)
  - [Scenario-Based Questions](#scenario-based-questions)
    - [Scenario: Optimistic Update](#scenario-optimistic-update)
