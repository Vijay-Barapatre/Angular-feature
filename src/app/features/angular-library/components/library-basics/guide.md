...
- [🔍 How It Works (The Concept)](#how-it-works-the-concept)
  - [Default Behavior (No Library)](#default-behavior-no-library)
  - [Optimized Behavior (With Library)](#optimized-behavior-with-library)
- [🚀 Step-by-Step Implementation Guide](#step-by-step-implementation-guide)
  - [Step 1: Generate the Library](#step-1-generate-the-library)
  - [Step 2: Understand the Generated Structure](#step-2-understand-the-generated-structure)
  - [Step 3: Configure public-api.ts](#step-3-configure-public-apits)
  - [Step 4: Configure package.json](#step-4-configure-packagejson)
  - [Step 5: Build the Library](#step-5-build-the-library)
- [🐛 Common Pitfalls & Debugging](#common-pitfalls--debugging)
  - [❌ Bad: Forgetting to Export](#bad-forgetting-to-export)
  - [✅ Good: Complete Exports](#good-complete-exports)
  - [❌ Bad: Regular Dependencies](#bad-regular-dependencies)
  - [✅ Good: Peer Dependencies](#good-peer-dependencies)
- [⚡ Performance & Architecture](#performance--architecture)
  - [Performance Benefits](#performance-benefits)
  - [Architecture Fit](#architecture-fit)
- [🌍 Real World Use Cases](#real-world-use-cases)
  - [📦 Data Flow Summary (Visual Box Diagram)](#data-flow-summary-visual-box-diagram)
- [🧱 LEGO Box Analogy (Easy to Remember!)](#lego-box-analogy-easy-to-remember)
