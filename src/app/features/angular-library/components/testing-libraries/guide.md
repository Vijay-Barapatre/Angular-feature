...
- [🔍 How It Works (The Concept)](#how-it-works-the-concept)
  - [Default Behavior (Untested)](#default-behavior-untested)
  - [Optimized Behavior (Tested)](#optimized-behavior-tested)
- [🚀 Step-by-Step Implementation Guide](#step-by-step-implementation-guide)
  - [Step 1: Run Tests](#step-1-run-tests)
  - [Step 2: Write Component Test](#step-2-write-component-test)
  - [Step 3: Write Service Test](#step-3-write-service-test)
- [🐛 Common Pitfalls & Debugging](#common-pitfalls--debugging)
  - [❌ Bad: Forgetting Imports](#bad-forgetting-imports)
  - [✅ Good: Import Standalone](#good-import-standalone)
  - [❌ Bad: No Spy on Output](#bad-no-spy-on-output)
  - [✅ Good: Spy First](#good-spy-first)
- [⚡ Performance & Architecture](#performance--architecture)
  - [Testing Pyramid](#testing-pyramid)
  - [Coverage Thresholds](#coverage-thresholds)
- [🌍 Real World Use Cases](#real-world-use-cases)
  - [📦 Data Flow Summary (Visual Box Diagram)](#data-flow-summary-visual-box-diagram)
- [🏭 Factory Quality Control Analogy (Easy to Remember!)](#factory-quality-control-analogy-easy-to-remember)
