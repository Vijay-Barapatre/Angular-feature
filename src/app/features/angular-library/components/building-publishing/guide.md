...
- [🔍 How It Works (The Concept)](#how-it-works-the-concept)
  - [Default Behavior (No Build)](#default-behavior-no-build)
  - [Optimized Behavior (Built Package)](#optimized-behavior-built-package)
- [🚀 Step-by-Step Implementation Guide](#step-by-step-implementation-guide)
  - [Step 1: Prepare package.json](#step-1-prepare-packagejson)
  - [Step 2: Build the Library](#step-2-build-the-library)
  - [Step 3: Navigate to Output](#step-3-navigate-to-output)
  - [Step 4: Publish to npm](#step-4-publish-to-npm)
- [🐛 Common Pitfalls & Debugging](#common-pitfalls--debugging)
  - [❌ Bad: Angular as Dependency](#bad-angular-as-dependency)
  - [✅ Good: Angular as Peer Dependency](#good-angular-as-peer-dependency)
  - [❌ Bad: Forgot to Build](#bad-forgot-to-build)
  - [✅ Good: Build Then Publish](#good-build-then-publish)
- [⚡ Performance & Architecture](#performance--architecture)
  - [Bundle Formats](#bundle-formats)
  - [sideEffects: false](#sideeffects-false)
- [🌍 Real World Use Cases](#real-world-use-cases)
  - [📦 Data Flow Summary (Visual Box Diagram)](#data-flow-summary-visual-box-diagram)
- [🎵 Music Album Analogy (Easy to Remember!)](#music-album-analogy-easy-to-remember)
