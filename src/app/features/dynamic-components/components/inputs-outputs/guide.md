...
- [🔍 How It Works (The Concept)](#how-it-works-the-concept)
  - [The `ComponentRef` Object](#the-componentref-object)
- [🚀 Step-by-Step Implementation Guide](#step-by-step-implementation-guide)
  - [1. Setting Inputs (`setInput`)](#1-setting-inputs-setinput)
  - [2. Subscribing to Outputs](#2-subscribing-to-outputs)
  - [3. Change Detection](#3-change-detection)
- [🐛 Common Pitfalls & Debugging](#common-pitfalls--debugging)
  - [1. Memory Leaks](#1-memory-leaks)
  - [2. `ngOnChanges` not firing](#2-ngonchanges-not-firing)
