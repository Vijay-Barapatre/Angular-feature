...
## 📋 Table of Contents
- [1. 🔍 Creating a Custom Pipe](#1--creating-a-custom-pipe)
...
- [3. ❓ Interview Questions](#3--interview-questions)
  - [Basic Questions](#basic-questions)
    - [Q1: What interface must custom pipes implement?](#q1-what-interface-must-custom-pipes-implement)
    - [Q2: How do you make a pipe standalone?](#q2-how-do-you-make-a-pipe-standalone)
  - [Scenario-Based Questions](#scenario-based-questions)
    - [Scenario: File Size Formatter](#scenario-file-size-formatter)
- [🍳 Recipe Analogy (Easy to Remember!)](#recipe-analogy-easy-to-remember)
  - [📖 Story to Remember:](#story-to-remember)
  - [🎯 Quick Reference:](#quick-reference)
- [🧠 Mind Map](#mind-map)
- [3. 🌟 Real-World Example: Smart Data Table (Filter + Sort + Format)](#3--real-world-example-smart-data-table-filter--sort--format)
  - [📦 The Transformation Flow](#the-transformation-flow)
  - [💻 The Code Implementation](#the-code-implementation)
    - [1. The Template (HTML)](#1-the-template-html)
    - [2. The TypeScript (Pipes & Component)](#2-the-typescript-pipes--component)
- [❓ Additional Interview Questions (20+)](#additional-interview-questions-20)
  - [Basic Questions](#basic-questions)
  - [Pure vs Impure Questions](#pure-vs-impure-questions)
  - [Chaining Questions](#chaining-questions)
  - [Scenario Questions](#scenario-questions)
  - [Dependency Injection Questions](#dependency-injection-questions)
