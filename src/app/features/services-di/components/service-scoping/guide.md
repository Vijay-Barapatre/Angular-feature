...
## 📋 Table of Contents
- [1. 🔍 What are Injection Tokens?](#1--what-are-injection-tokens)
- [2. 🚀 Providing Token Values](#2--providing-token-values)
  - [Using in Service/Component](#using-in-servicecomponent)
  - [📊 Data Flow Diagram](#data-flow-diagram)
  - [📦 Data Flow Summary (Visual Box Diagram)](#data-flow-summary-visual-box-diagram)
- [3. ❓ Interview Questions](#3--interview-questions)
  - [Basic Questions](#basic-questions)
    - [Q1: Why use InjectionToken instead of string token?](#q1-why-use-injectiontoken-instead-of-string-token)
    - [Q2: Can InjectionToken have a default value?](#q2-can-injectiontoken-have-a-default-value)
  - [Scenario-Based Questions](#scenario-based-questions)
    - [Scenario: Environment-Based Config](#scenario-environment-based-config)
- [🤝 Secret Handshake Analogy (Easy to Remember!)](#secret-handshake-analogy-easy-to-remember)
  - [📖 Story to Remember:](#story-to-remember)
  - [🎯 Quick Reference:](#quick-reference)
- [🧠 Mind Map](#mind-map)
- [🎯 What Problem Does This Solve?](#what-problem-does-this-solve)
  - [The Problem: Hardcoding & Name Collisions](#the-problem-hardcoding--name-collisions)
  - [How InjectionToken Solves This](#how-injectiontoken-solves-this)
- [📚 Key Classes & Types Explained](#key-classes--types-explained)
  - [1. `InjectionToken<T>`](#1-injectiontokent)
  - [2. `Provider` Object](#2-provider-object)
  - [3. `inject()` with Tokens](#3-inject-with-tokens)
- [🌍 Real-World Use Cases](#real-world-use-cases)
  - [1. Global App Configuration](#1-global-app-configuration)
  - [2. API Endpoint URLs (Environment Variables)](#2-api-endpoint-urls-environment-variables)
  - [3. Third-Party Library Config (e.g., Firebase)](#3-third-party-library-config-eg-firebase)
  - [4. Platform ID (SSR vs Browser)](#4-platform-id-ssr-vs-browser)
  - [5. Window/Document Object (SSR Safe)](#5-windowdocument-object-ssr-safe)
  - [Basic Questions](#basic-questions)
  - [Provider Types Questions](#provider-types-questions)
  - [Default Value Questions](#default-value-questions)
