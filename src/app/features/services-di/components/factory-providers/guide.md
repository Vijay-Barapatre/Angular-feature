...
## 📋 Table of Contents
- [1. 🔍 Resolution Modifiers](#1--resolution-modifiers)
...
- [🎯 What Problem Does This Solve?](#what-problem-does-this-solve)
  - [The Problem: Uncontrolled Dependency Search](#the-problem-uncontrolled-dependency-search)
  - [How Modifiers Solve This](#how-modifiers-solve-this)
- [📚 Key Classes & Types Explained](#key-classes--types-explained)
  - [1. `@Optional()`](#1-optional)
  - [2. `@Self()`](#2-self)
  - [3. `@SkipSelf()`](#3-skipself)
  - [4. `@Host()`](#4-host)
- [🌍 Real-World Use Cases](#real-world-use-cases)
  - [1. Recursive Components (Tree)](#1-recursive-components-tree)
  - [2. Form Control Value Accessors](#2-form-control-value-accessors)
  - [3. Optional Plugins / theming](#3-optional-plugins--theming)
  - [4. Isolated Directives](#4-isolated-directives)
