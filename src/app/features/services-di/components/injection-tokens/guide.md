...
## 📋 Table of Contents
- [1. 🔍 Injector Hierarchy](#1--injector-hierarchy)
- [2. 🚀 Component-Level Providers](#2--component-level-providers)
  - [Override Parent Service](#override-parent-service)
  - [📊 Data Flow Diagram](#data-flow-diagram)
  - [📦 Data Flow Summary (Visual Box Diagram)](#data-flow-summary-visual-box-diagram)
- [🎯 What Problem Does This Solve?](#what-problem-does-this-solve)
  - [The Problem: Global Singletons Aren't Always Enough](#the-problem-global-singletons-arent-always-enough)
  - [How Hierarchical DI Solves This](#how-hierarchical-di-solves-this)
- [📚 Key Classes & Types Explained](#key-classes--types-explained)
  - [1. `ElementInjector`](#1-elementinjector)
  - [2. `ModuleInjector`](#2-moduleinjector)
  - [3. Resolution Rules](#3-resolution-rules)
- [🌍 Real-World Use Cases](#real-world-use-cases)
  - [1. Isolated Widget State (e.g., Accordion, Tabs)](#1-isolated-widget-state-eg-accordion-tabs)
  - [2. Data Tables with Pagination](#2-data-tables-with-pagination)
  - [3. Smart/Dumb Component Architecture](#3-smartdumb-component-architecture)
  - [4. Overriding for specific sections](#4-overriding-for-specific-sections)
  - [5. Services limited to a Route](#5-services-limited-to-a-route)
