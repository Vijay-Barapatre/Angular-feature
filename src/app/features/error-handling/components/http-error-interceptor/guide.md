...
## 📋 Table of Contents
- [1. 🔍 Error Interceptor](#1--error-interceptor)
- [2. 🚀 Advanced: Retry on Failure](#2--advanced-retry-on-failure)
- [3. ❓ Interview Questions](#3--interview-questions)
  - [Basic Questions](#basic-questions)
    - [Q1: Why use interceptor for errors?](#q1-why-use-interceptor-for-errors)
    - [Q2: Should you rethrow the error?](#q2-should-you-rethrow-the-error)
  - [Scenario-Based Questions](#scenario-based-questions)
    - [Scenario: Auto-Logout on 401](#scenario-auto-logout-on-401)
  - [📦 Data Flow Summary (Visual Box Diagram)](#data-flow-summary-visual-box-diagram)
- [🚧 Toll Booth Analogy (Easy to Remember!)](#toll-booth-analogy-easy-to-remember)
