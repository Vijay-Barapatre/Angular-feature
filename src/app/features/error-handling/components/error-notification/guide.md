...
## 📋 Table of Contents
- [1. 🔍 Basic catchError](#1--basic-catcherror)
...
- [3. ❓ Interview Questions](#3--interview-questions)
  - [Basic Questions](#basic-questions)
    - [Q1: catchError vs global ErrorHandler?](#q1-catcherror-vs-global-errorhandler)
    - [Q2: What happens if you don't use catchError?](#q2-what-happens-if-you-dont-use-catcherror)
  - [Scenario-Based Questions](#scenario-based-questions)
    - [Scenario: Multiple API Fallback](#scenario-multiple-api-fallback)
  - [📦 Data Flow Summary (Visual Box Diagram)](#data-flow-summary-visual-box-diagram)
- [🎪 Safety Net Analogy (Easy to Remember!)](#safety-net-analogy-easy-to-remember)
