...
## 📋 Table of Contents
- [📸 Visual Guide: Real-World Directive Patterns](#visual-guide-real-world-directive-patterns)
  - [🔐 1. Permission Directive - Role-Based Access Control](#1-permission-directive---role-based-access-control)
  - [🖼️ 2. Lazy Load Directive - Performance Optimization](#2-lazy-load-directive---performance-optimization)
  - [📋 3. Copy to Clipboard Directive - One-Click Copy](#3-copy-to-clipboard-directive---one-click-copy)
  - [⏱️ 4. Debounce Click Directive - Prevent Double Submissions](#4-debounce-click-directive---prevent-double-submissions)
  - [🎯 5. AutoFocus Directive - Instant User Input](#5-autofocus-directive---instant-user-input)
- [0. 🏗️ The Directives Power Duo: TemplateRef & ViewContainerRef](#0--the-directives-power-duo-templateref--viewcontainerref)
...
- [2. 🚀 Step-by-Step Implementation Guide](#2--step-by-step-implementation-guide)
  - [Directive 1: *appPermission (Structural)](#directive-1-apppermission-structural)
  - [Directive 2: appCopyToClipboard](#directive-2-appcopytoclipboard)
  - [📊 Copy Flow](#copy-flow)
  - [Directive 3: appDebounceClick](#directive-3-appdebounceclick)
  - [Directive 4: appAutoFocus](#directive-4-appautofocus)
  - [Directive 5: appLazyLoad (Images)](#directive-5-applazyload-images)
- [3. 🐛 Common Pitfalls & Debugging](#3--common-pitfalls--debugging)
  - [❌ Bad Example: Permission Check on Init Only](#bad-example-permission-check-on-init-only)
  - [✅ Good Example: Subscribe to Auth Changes](#good-example-subscribe-to-auth-changes)
...
- [5. 🌍 Real World Use Cases](#5--real-world-use-cases)
  - [1. 🔐 Admin Panel Controls](#1--admin-panel-controls)
  - [2. 📋 Code Documentation](#2--code-documentation)
  - [3. 💳 Payment Forms](#3--payment-forms)
...
## 📸 Visual Guide: Real-World Directive Patterns

### 🔐 1. Permission Directive - Role-Based Access Control
Control UI visibility based on user roles. Remove elements from DOM completely for unauthorized users.

![Permission Directive Explained](./1-permission-directive.png)

---

### 🖼️ 2. Lazy Load Directive - Performance Optimization
Load images only when they enter the viewport. Dramatically reduces initial page load time.

![Lazy Load Directive Explained](./2-lazy-load-directive.png)

---

### 📋 3. Copy to Clipboard Directive - One-Click Copy
Enable quick copying of text with visual feedback. Uses modern Clipboard API.

![Copy to Clipboard Directive Explained](./3-copy-clipboard-directive.png)

---

### ⏱️ 4. Debounce Click Directive - Prevent Double Submissions
Stop accidental double-clicks from creating duplicate submissions or API calls.

![Debounce Click Directive Explained](./4-debounce-click-directive.png)

---

### 🎯 5. AutoFocus Directive - Instant User Input
Automatically focus input fields for better UX. No more clicking to start typing.

![AutoFocus Directive Explained](./5-autofocus-directive.png)
