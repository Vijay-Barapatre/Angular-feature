...
- [🏛️ What Problem Does It Solve?](#what-problem-does-it-solve)
  - [The "Spammy Events" Problem](#the-spammy-events-problem)
...
- [🔬 Deep Dive: Important Classes & Directives](#deep-dive-important-classes--directives)
  - [A. The Observable Streams](#a-the-observable-streams)
  - [B. The Configuration](#b-the-configuration)
...
- [2. 🚀 Step-by-Step Implementation](#2--step-by-step-implementation)
  ...
  - [🛡️ Always Unsubscribe!](#always-unsubscribe)
- [3. 🌍 Real World Use Cases](#3--real-world-use-cases)
  - [📦 Data Flow Summary (Visual Box Diagram)](#data-flow-summary-visual-box-diagram)
- [7. ❓ Interview & Concept Questions](#7--interview--concept-questions)
  - [Q1: What does `emitEvent: false` do?](#q1-what-does-emitevent-false-do)
  - [Q2: How do you prevent Infinite Loops in `valueChanges`?](#q2-how-do-you-prevent-infinite-loops-in-valuechanges)
  - [Q3: Why use `distinctUntilChanged()`?](#q3-why-use-distinctuntilchanged)
  - [Q4: What is the difference between `pairwise()` and `startWith()`?](#q4-what-is-the-difference-between-pairwise-and-startwith)
  - [Q5: Does `valueChanges` emit when the control is Disabled?](#q5-does-valuechanges-emit-when-the-control-is-disabled)
  - [Q6: How do you auto-save a form?](#q6-how-do-you-auto-save-a-form)
  - [Q7: Why use `switchMap` for search?](#q7-why-use-switchmap-for-search)
  - [Q8: What happens if I forget to unsubscribe?](#q8-what-happens-if-i-forget-to-unsubscribe)
  - [Q9: Can I listen to `valueChanges` of a specific nested control?](#q9-can-i-listen-to-valuechanges-of-a-specific-nested-control)
  - [Q10: How to detect *which* control caused the form change?](#q10-how-to-detect-which-control-caused-the-form-change)
  - [Q11: Does `valueChanges` emit invalid values?](#q11-does-valuechanges-emit-invalid-values)
  - [Q12: How to trigger `valueChanges` manually?](#q12-how-to-trigger-valuechanges-manually)
  - [Q13: What is the generic type of `valueChanges`?](#q13-what-is-the-generic-type-of-valuechanges)
  - [Q14: (Scenario) User selects Country. State dropdown loads. How?](#q14-scenario-user-selects-country-state-dropdown-loads-how)
  - [Q15: How to format the value *before* it reaches the model?](#q15-how-to-format-the-value-before-it-reaches-the-model)
  - [Q16: Can I use `async` pipe with `valueChanges`?](#q16-can-i-use-async-pipe-with-valuechanges)
  - [Q17: Why might `valueChanges` not fire when I type?](#q17-why-might-valuechanges-not-fire-when-i-type)
  - [Q18: Difference between `statusChanges` and checking `form.invalid`?](#q18-difference-between-statuschanges-and-checking-forminvalid)
  - [Q19: How to log ALL form changes for debugging?](#q19-how-to-log-all-form-changes-for-debugging)
  - [Q20: If I have `debounceTime(300)`, and I submit immediately, do I get the latest value?](#q20-if-i-have-debouncetime300-and-i-submit-immediately-do-i-get-the-latest-value)
