# 🛡️ Custom Validators (Sync & Async)
...
- [🏛️ What Problem Does It Solve?](#what-problem-does-it-solve)
  - [The "Specific Business Rule" Problem](#the-specific-business-rule-problem)
  - [The "Server-Side Check" Problem](#the-server-side-check-problem)
- [🔬 Deep Dive: Important Classes & Directives](#deep-dive-important-classes--directives)
  - [A. The Types (TypeScript Side)](#a-the-types-typescript-side)
...
- [1. 🔍 How It Works (The Concept)](#1--how-it-works-the-concept)
  ...
  - [Sync vs Async Validators](#sync-vs-async-validators)
  - [📊 Validator Execution Flow](#validator-execution-flow)
- [2. 🚀 Step-by-Step Implementation Guide](#2--step-by-step-implementation-guide)
  - [Step 1: Create Sync Validator Function](#step-1-create-sync-validator-function)
  - [Step 2: Create Factory Validator (Configurable)](#step-2-create-factory-validator-configurable)
  - [Step 3: Create Async Validator](#step-3-create-async-validator)
  - [Step 4: Apply to FormControl](#step-4-apply-to-formcontrol)
  - [📊 Validator Registration](#validator-registration)
- [3. 🐛 Common Pitfalls & Debugging](#3--common-pitfalls--debugging)
  - [❌ Pitfall 1: Forgetting to Return null for Valid](#pitfall-1-forgetting-to-return-null-for-valid)
  - [❌ Pitfall 2: Async Validator Not Returning Observable](#pitfall-2-async-validator-not-returning-observable)
  - [❌ Pitfall 3: Async Validators Running on Every Keystroke](#pitfall-3-async-validators-running-on-every-keystroke)
- [4. ⚡ Performance & Architecture](#4--performance--architecture)
  - [Performance Tips](#performance-tips)
  - [Debounced Async Validator](#debounced-async-validator)
...
- [7. ❓ Interview & Concept Questions](#7--interview--concept-questions)
  - [Q1: What's the signature of a sync validator?](#q1-whats-the-signature-of-a-sync-validator)
  - [Q2: How do async validators differ from sync?](#q2-how-do-async-validators-differ-from-sync)
  - [Q3: How do you create a configurable validator?](#q3-how-do-you-create-a-configurable-validator)
  - [Q4: What is `control.pending`?](#q4-what-is-controlpending)
  - [Q5 (Scenario): Check if email exists in database. How?](#q5-scenario-check-if-email-exists-in-database-how)
  - [Q6: What is a "Factory Validator"?](#q6-what-is-a-factory-validator)
  - [Q7: Why must an Async Validator return an Observable that completes?](#q7-why-must-an-async-validator-return-an-observable-that-completes)
  - [Q8: Can a validator access other controls?](#q8-can-a-validator-access-other-controls)
  - [Q9: How do you manually set an error on a control?](#q9-how-do-you-manually-set-an-error-on-a-control)
  - [Q10: How do you clear a specific error manually?](#q10-how-do-you-clear-a-specific-error-manually)
  - [Q11: (Scenario) Async validator runs too often.](#q11-scenario-async-validator-runs-too-often)
  - [Q12: What happens if both Sync and Async validators fail?](#q12-what-happens-if-both-sync-and-async-validators-fail)
  - [Q13: Can you reuse a validator across different projects?](#q13-can-you-reuse-a-validator-across-different-projects)
  - [Q14: How do you unit test a custom validator?](#q14-how-do-you-unit-test-a-custom-validator)
  - [Q15: Why might `control.parent` be null inside a validator?](#q15-why-might-controlparent-be-null-inside-a-validator)
  - [Q16: How do you combine multiple Async Validators?](#q16-how-do-you-combine-multiple-async-validators)
  - [Q17: What does `Validators.compose()` do?](#q17-what-does-validatorscompose-do)
  - [Q18: (Scenario) How to validate that a list (FormArray) has unique values?](#q18-scenario-how-to-validate-that-a-list-formarray-has-unique-values)
  - [Q19: Explain `ValidationErrors` type relationship with `any`.](#q19-explain-validationerrors-type-relationship-with-any)
  - [Q20: How do you show a "User not found" error that comes from the backend AFTER submit?](#q20-how-do-you-show-a-user-not-found-error-that-comes-from-the-backend-after-submit)
  - [Q21: Can you use Dependency Injection in a custom validator function?](#q21-can-you-use-dependency-injection-in-a-custom-validator-function)
