...
- [🏛️ What Problem Does It Solve?](#what-problem-does-it-solve)
  - [The "Flat Data" Mismatch](#the-flat-data-mismatch)
  - [The Component Reusability Issue](#the-component-reusability-issue)
...
- [1. 🔍 How It Works (The Concept)](#1--how-it-works-the-concept)
  ...
  - [📊 Nested Structure Visualization](#nested-structure-visualization)
- [2. 🚀 Step-by-Step Implementation Guide](#2--step-by-step-implementation-guide)
  - [Step 1: Create Nested FormGroup Structure](#step-1-create-nested-formgroup-structure)
  - [Step 2: Bind Nested Groups in Template](#step-2-bind-nested-groups-in-template)
  - [Step 3: Access Nested Values](#step-3-access-nested-values)
  - [📊 Template Binding Flow](#template-binding-flow)
- [3. 🐛 Common Pitfalls & Debugging](#3--common-pitfalls--debugging)
  - [❌ Pitfall 1: Missing formGroupName](#pitfall-1-missing-formgroupname)
  - [❌ Pitfall 2: setValue with Missing Nested Fields](#pitfall-2-setvalue-with-missing-nested-fields)
- [4. ⚡ Performance & Architecture](#4--performance--architecture)
  - [Performance Benefits](#performance-benefits)
  - [Architecture: Reusable Form Groups](#architecture-reusable-form-groups)
...
- [7. ❓ Interview & Concept Questions](#7--interview--concept-questions)
  - [Q1: How do you bind a nested FormGroup in the template?](#q1-how-do-you-bind-a-nested-formgroup-in-the-template)
  - [Q2: How do you access a deeply nested control's value?](#q2-how-do-you-access-a-deeply-nested-controls-value)
  - [Q3: Can you reset just a nested group without affecting the parent?](#q3-can-you-reset-just-a-nested-group-without-affecting-the-parent)
  - [Q4: What happens if formGroupName doesn't match a key?](#q4-what-happens-if-formgroupname-doesnt-match-a-key)
  - [Q5 (Scenario): You have billing and shipping addresses. How do you structure this?](#q5-scenario-you-have-billing-and-shipping-addresses-how-do-you-structure-this)
  - [Q6: If a nested control is invalid, is the parent valid?](#q6-if-a-nested-control-is-invalid-is-the-parent-valid)
  - [Q7: How do you validate two fields inside a nested group (e.g., Start Date < End Date)?](#q7-how-do-you-validate-two-fields-inside-a-nested-group-eg-start-date--end-date)
  - [Q8: Can you nest a FormArray inside a FormGroup?](#q8-can-you-nest-a-formarray-inside-a-formgroup)
  - [Q9: What is `ControlContainer` used for?](#q9-what-is-controlcontainer-used-for)
  - [Q10: How do you dynamically remove a nested group?](#q10-how-do-you-dynamically-remove-a-nested-group)
  - [Q11: Does `patchValue` work recursively?](#q11-does-patchvalue-work-recursively)
  - [Q12: Why use `formGroupName` vs passing `[formGroup]="nestedInstance"`?](#q12-why-use-formgroupname-vs-passing-formgroupnestedinstance)
  - [Q13: (Scenario) API returns `address_street` (flat) but you use nested groups. How to handle?](#q13-scenario-api-returns-address_street-flat-but-you-use-nested-groups-how-to-handle)
  - [Q14: How do you disable an entire nested group?](#q14-how-do-you-disable-an-entire-nested-group)
  - [Q15: What is the return type of `form.get('address')`?](#q15-what-is-the-return-type-of-formgetaddress)
  - [Q16: (Scenario) User has a "Billing same as Shipping" checkbox. How to implement?](#q16-scenario-user-has-a-billing-same-as-shipping-checkbox-how-to-implement)
  - [Q17: Can a FormGroup have NO controls?](#q17-can-a-formgroup-have-no-controls)
  - [Q18: Difference between `formGroup.value` and `formGroup.getRawValue()`?](#q18-difference-between-formgroupvalue-and-formgroupgetrawvalue)
  - [Q19: How do you test a nested validator?](#q19-how-do-you-test-a-nested-validator)
  - [Q20: (Scenario) How to show an error if ANY field in the address group is touched and invalid?](#q20-scenario-how-to-show-an-error-if-any-field-in-the-address-group-is-touched-and-invalid)
  - [Q21: What happens if you duplicate a key in a FormGroup?](#q21-what-happens-if-you-duplicate-a-key-in-a-formgroup)
