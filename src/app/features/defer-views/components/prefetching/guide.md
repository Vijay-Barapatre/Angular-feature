...
## 📋 Table of Contents
- [How Prefetching Works](#how-prefetching-works)
- [Prefetch Options](#prefetch-options)
  - [📦 Data Flow Summary (Visual Box Diagram)](#data-flow-summary-visual-box-diagram)
- [🍿 Popcorn Prep Analogy (Easy to Remember!)](#popcorn-prep-analogy-easy-to-remember)
...
│   WITHOUT PREFETCH:                                         │
│   ┌───────────────────────────────────────────────────────┐ │
│   │ User clicks → Wait for download → Wait more → Show ❌ │ │
│   └───────────────────────────────────────────────────────┘ │
│                                                             │
│   WITH PREFETCH:                                            │
│   ┌───────────────────────────────────────────────────────┐ │
│   │ Browser idle → Download in background                 │ │
│   │ User clicks → Already have it → Show instantly! ✅    │ │
│   └───────────────────────────────────────────────────────┘ │
│                                                             │
│   TIMING:                                                   │
│   ┌───────────────────────────────────────────────────────┐ │
│   │ prefetch on idle     → During browser idle time       │ │
│   │ prefetch on hover    → When mouse approaches          │ │
│   │ prefetch on viewport → When area becomes visible      │ │
│   │ prefetch on immediate→ Right after main bundle        │ │
│   │                                                       │ │
│   │ BUT render still waits for actual trigger!            │ │
│   └───────────────────────────────────────────────────────┘ │
└─────────────────────────────────────────────────────────────┘
```

> **Key Takeaway**: Prefetch downloads code BEFORE it's needed. When user triggers, it's already there = instant!
